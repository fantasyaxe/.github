...
<p align="center" style="font-size: 15px">
    <b>
   		Данный проект является скорее проверкой моих личных навыков в разработке чего-то там.
		<br> В данный момент цель этого проекта - Создать инвраструктуру для оживления версии майнкрафта 1.5.2
		<br> Я не знаю зачем, просто я люблю эту версию
    </b>
</p>
